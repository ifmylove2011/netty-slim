...
import io.netty.util.internal.shaded.jctools.queues.MpscArrayQueue;
import io.netty.util.internal.shaded.jctools.queues.MpscChunkedArrayQueue;
import io.netty.util.internal.shaded.jctools.queues.MpscUnboundedArrayQueue;
import io.netty.util.internal.shaded.jctools.queues.SpscLinkedQueue;
import io.netty.util.internal.shaded.jctools.queues.atomic.MpscAtomicArrayQueue;
import io.netty.util.internal.shaded.jctools.queues.atomic.MpscGrowableAtomicArrayQueue;
import io.netty.util.internal.shaded.jctools.queues.atomic.MpscUnboundedAtomicArrayQueue;
import io.netty.util.internal.shaded.jctools.queues.atomic.SpscLinkedAtomicQueue;
...
public final class PlatformDependent {
    ...
    private static final class Mpsc {
        ...
        static {
            ...
            if (unsafe == null) {
                logger.debug("io.netty.util.internal.shaded.jctools-core.MpscChunkedArrayQueue: unavailable");
                USE_MPSC_CHUNKED_ARRAY_QUEUE = false;
            } else {
                logger.debug("io.netty.util.internal.shaded.jctools-core.MpscChunkedArrayQueue: available");
